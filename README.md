...
###  __EPIC (DSPM-11) [project] E-commerce team project 1:__
  <br>
...
### __user story (DSPM-21)[business_understanding] Understanding and identifying the business problem of the given e-commerce dataset from Kaggle.__
...
### __user story (DSPM-29)[data_investigation_stage] Understanding the given datasets, data curation and data modelling. (17.04.2023 - 18.04.2023)__
...
### __user story (DSPM-30)[data_analysis_visualization] Exploratory Data Analysis (EDA), key question from data and data visualizations. (xx.04.2023)__
...
## <span style="color:grey"> __Steps for the days based on the business understanding stage (16.04.2023):__ 
 
---

### Steps (Team Collaboration)
  
* Access the Kaggle Dataset: [E-commerce Sales Data Source](https://www.kaggle.com/datasets/thedevastator/unlock-profits-with-e-commerce-sales-data.)

* Understand and discuss the stakeholders business requirements based on the brief provided (i.e details published in the about section on kaggle).
  
  - The Stakeholders in this scenario are both the kaggle dataset publishers and also us as team since its a kaggle challenge.

* Sprint Planning using Jira Software:
  
  - Agile project planning using scrum methodology

  -  On Jira reate child-issues in the user story, (DSPM - 29)[business_understanding] detailing out the possible business requirements gotten from the brief and discuss.
  
  - Create sprint, set sprint details add issues from backlog to sprint and start sprint. (2 weeks sprint, 16.04.2023 - 23.04.2023)
...
## <span style="color:grey"> __Steps for the days task based on the data investigation stage (17.04.2023):__ 
...
* Create child-issues in this user story, (DPSM-30)[data_investigation_stage] detailing out the insights or questions you got based on the dataset.

* About the data file chosen: Create also locally a documentation in markdown format (.md) that explains the details of the dataset, key insights based on the business understanding(requirements) user story we did yesterday.
...
* Extra Steps:
  ...
  - Carry out Exploratory Data Analysis and Visualization (This is for next stage though)
...
---
 ...
 ## <span style="color:grey"> __Steps for the days task based on the data investigation stage (cont) (18.04.2023):__ 

---

* Key Questions to Help Guide your Data Investigation Documentation Process

  - What details did you find out about the dataset?
  - What are the important dataset properties you think is in the data file?
  - Based on your data investigation, could you find any correlation between your data file and the business requirements listed in the (DSPM-21)[business_understanding] user story? 
  - Are there any other possible business problems you think could be tackled by us?
  - Based on both the business and data understanding process we have tackled, could you think of any business solution(s) we could implement? 
